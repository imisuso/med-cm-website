<template>
    <AppLayout>
        ...
        <div class=" 2xl:container 2xl:mx-auto md:py-6 lg:px-20 md:px-6 py-2 px-4">
            <div class=" flex flex-col ">
                ...
                <template v-for="unit in props.units" :key="unit.id">
                    <OfficerDetail v-if="unit.division_id !== 19" :unit="unit" />
                </template>
            </div>
        </div>
    </AppLayout>
