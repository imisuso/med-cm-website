                    ...
                    <div class="grid grid-cols-12">
                        ...
                        <div class="col-span-2 md:col-span-1">
                            <div class="flex flex-col space-y-2 items-end sm:space-y-1 sm:items-center">
                                <Link :href="route('admin.user_ability_role.index')" class="flex items-center mx-1 text-orange-500 bg-white hover:bg-orange-100 focus:ring-4 focus:ring-orange-300 rounded-full border border-orange-200 text-sm font-medium px-2 py-2 hover:text-orange-900 focus:z-10">
