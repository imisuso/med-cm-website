<template>
    ...
    <div class="flex flex-col w-64 h-screen overflow-y-auto border-r bg-sky-300">
        <!-- <h2 class="text-3xl font-semibold text-center text-gray-800">Brand</h2> -->

        <div class="flex flex-col items-center mt-1 mx-2">
            <!-- <svg v-if="! $page.props.auth.person_image" class="object-cover rounded-full w-24 h-24 text-gray-300" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex flex-col justify-between flex-1 mt-2">
            <nav>
                <a
                    ...
                    class="flex items-center px-4 py-2 mt-1 text-gray-600 transition-colors duration-200 transform hover:bg-gray-200 hover:text-gray-700"
                >
        ...
        <div class="flex flex-col justify-between flex-1 mt-2">
            <nav>
                ...
                <Link
                        ...
                        class="flex items-center w-full px-4 py-2 mt-1 text-gray-600 transition-colors duration-200 transform hover:bg-gray-200 hover:text-gray-700"
                >
                ...
                <!-- <a class="flex items-center px-4 py-2 mt-1 text-gray-600 transition-colors duration-200 transform hover:bg-gray-200 hover:text-gray-700" href="#">
                    <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <!-- <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform hover:bg-gray-200 hover:text-gray-700" href="#">
                    <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
