<template>
    <div class="bg-green-800">
        <div
        class="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-(--breakpoint-xl) md:px-24 lg:px-8"
        >
...
<!--                                <nav>-->
<!--                                <div class="mt-6 mb-6 underline text-lg">เมนูการจัดการ</div>-->
<!--                                <ul class="space-y-4">-->
<!--                                <li>-->
<!--                                    <a -->
