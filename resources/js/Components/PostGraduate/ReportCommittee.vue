<template>
    <div class="container px-5 py-8 mx-auto">
        <div class="flex justify-center mb-2">
            <div class="w-full overflow-hidden rounded-lg shadow sm:w-auto sm:mx-2">
                ...
                <ul class="flex flex-col p-4 mx-auto space-y-8 sm:p-10 text-xl list-outside list-disc">
                    <a href="../../../../images/post_graduate/report/8-02-2567.pdf" target="_blank" class="py-1 outline-none cursor-pointer text-lg md:text-xl"><li> 8 กุมภาพันธ์ 2567 </li></a>
                </ul>
            </div>
        </div>
    </div>
