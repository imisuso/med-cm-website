...
//PersonController => แสดงผลข้อมูลเกี่ยวกับ บุคคลากรในภาควิชา
Route::prefix('admin')
    ->middleware(['auth', 'can:view_person'])
    ...
    ->group(function () {
        ...
        Route::get('/person/list_by_division_and_type', 'listPersonByDivisionAndType')->name('admin.person.list_by_division_and_type');
    });
//PersonController => เพิ่ม ลบ และ จัดการ เกี่ยวกับ บุคคลากรในภาควิชา
Route::prefix('admin')
